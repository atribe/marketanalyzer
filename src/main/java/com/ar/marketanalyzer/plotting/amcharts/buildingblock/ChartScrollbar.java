...
public class ChartScrollbar implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2164972469516172257L;
	...
	public AmGraph getGraphOld() {
		return graphOld;
	}
	public void setGraphOld(AmGraph graphOld) {
