...
public class Legend implements Serializable {
    ...
    public Legend setBottom(double bottom) {
        this.bottom = bottom;
        return this;
    }
    ...
    public Legend setFontSize(double fontSize) {
    ...
    public Legend setHorizontalGap(double horizontalGap) {
    ...
    public Legend setLeft(double left) {
        this.left = left;
        return this;
    }
    ...
    public Legend setMarginBottom(double marginBottom) {
    ...
    public Legend setMarginLeft(double marginLeft) {
    ...
    public Legend setMarginRight(double marginRight) {
    ...
    public Legend setMarginTop(double marginTop) {
    ...
    public Legend setMarkerBorderThickness(double markerBorderThickness) {
    ...
    public Legend setMarkerLabelGap(double markerLabelGap) {
    ...
    public Legend setMarkerSize(double markerSize) {
    ...
    public Legend setMarkerType(String markerType) {
    ...
    public Legend setMaxColumns(double maxColumns) {
    ...
    public Legend setPosition(String position) {
    ...
    public Legend setRight(double right) {
        this.right = right;
        return this;
    }
    ...
    public Legend setSpacing(double spacing) {
    ...
    public Legend setSwitchType(String switchType) {
    ...
    public Legend setTop(double top) {
        this.top = top;
        return this;
    }
    ...
    public Legend setValueAlign(String valueAlign) {
    ...
    public Legend setValueWidth(double valueWidth) {
    ...
    public Legend setVerticalGap(double verticalGap) {
    ...
    public Legend setWidth(double width) {
        this.width = width;
        return this;
    }
