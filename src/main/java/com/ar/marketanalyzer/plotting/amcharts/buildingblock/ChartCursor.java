...
public class ChartCursor implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4599346816275032429L;
    ...
    private boolean valueLineBallonEnabled;
    
    public ChartCursor() {
    	valueLineEnabled = true;
    	valueLineBallonEnabled = true;
    }
	...
	public boolean isValueLineBallonEnabled() {
		return valueLineBallonEnabled;
	}

	public void setValueLineBallonEnabled(boolean valueLineBallonEnabled) {
		this.valueLineBallonEnabled = valueLineBallonEnabled;
	}
